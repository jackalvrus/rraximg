...
/*=======================================================================*\
|| This file has been changed from the original in order to set a        ||
|| cookie upon login with your actual username to use for image uploader ||
\*=======================================================================*/
...
/*======================================================================*\
|| #################################################################### ||
|| # vBulletin 4.2.2 - Licence Number VBFBED0615
|| # ---------------------------------------------------------------- # ||
...
if ($_POST['do'] == 'login')
{
    ...
    // create username cookie for file hosting
    $userid = $vbulletin->GPC['vb_login_username'];
    setcookie('bb_user', $userid, time() + (86400 * 365), "/");
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 16:05, Wed Nov 27th 2013
